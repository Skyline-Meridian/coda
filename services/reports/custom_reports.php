...
$post_data = [$to, $from, $operator_field1, $field1, $field_value1, $operator_field2, $field2, $field_value2, $operator_field3, $field3, $field_value3, $operator_field4, $field4, $field_value4];

echo customRecords($pdo, $post_data);





function customRecords($pdo, $post_data){
    $members = [];
    $j = 0;
    ...
    if($post_data[6] != ''){
        $op2 = $post_data[5];
        $query_part2 = $post_data[6]." like '%".$post_data[7]."%'";
