        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="reports">
              <ul class="nav flex-column sub-menu">
                <!-- <li class="nav-item"> <a class="nav-link" href="<?php// echo $baseurl;?>pages/reports/yearly_reports.php">Rapports annuels</a></li> -->
...
<!-- <li class="nav-item">
            <a class="nav-link" href="<?php //echo $baseurl;?>pages/logout.php">
              <i class="icon-layers menu-icon"></i>
